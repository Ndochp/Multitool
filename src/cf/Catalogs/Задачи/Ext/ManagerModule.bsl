...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	//+++ Проверить, нафига МВТ и нельзя ли без него.
	...
	|	ВЫБОР
	|		КОГДА Задачи.КодПроекта = """"
	|			ТОГДА ЕСТЬNULL(КэшированныеРеквизитыРодителейЗадач.КодПроекта, """")
	|		ИНАЧЕ Задачи.КодПроекта
	|	КОНЕЦ КАК КодПроекта
	|ИЗ
	|	Справочник.Задачи КАК Задачи
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.КэшированныеРеквизитыРодителейЗадач КАК КэшированныеРеквизитыРодителейЗадач
	|		ПО (КэшированныеРеквизитыРодителейЗадач.Задача = Задачи.Ссылка)
	|ГДЕ
...
Процедура ОбработкаПолученияПредставленияОЛД(Данные, Представление, СтандартнаяОбработка)
	Перем Запрос;
	СтандартнаяОбработка = Ложь;
...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	Параметры.Отбор.Вставить("Решена", Ложь);
